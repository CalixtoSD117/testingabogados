...
export const ModalDelete = ({ setopen, open, id, deleteClient }) => {
                            ...
                            <div className='bg-white rounded md:w-auto w-[350px]'>
                                <div className='p-4'>
                                    <div className='flex flex-col justify-center items-start gap-5'>
                                        <h1 className='text-2xl font-semibold text-gray-700'>Eliminar cliente {id}</h1>
                                        <span className='text-gray-500'>¿Estas seguro de que quieres eliminar este cliente?</span>
                                    ...
                                    <div className='flex flex-row gap-2 justify-between items-center mt-5'>
                                        ...
                                        <button onClick={() => deleteClient(id)} className='bg-red-500 text-white px-2 py-1 rounded-md hover:bg-red-600 transition-all'>
                                            Confirmar
                                        </button>
                                    </div>
                                </div>
