        ...
        return (
            ...
            <div key={index}
                ...
                <div className='relative flex flex-col items-center text-teal-600'>
                    ...
                    <div className={`absolute top-0 text-center mt-16 w-32 text-base font-medium uppercase ${step.highlighted ? 'text-gray-900 ' : 'text-gray-400'}`}>
                        {/* Display descripccion */}
                        {step.description}
                        
                    </div>
                </div>
                <div className={`flex-auto border-t-2 transition duration-500 ease-in-out ${step.completed ? 'border-green-600' : 'border-fray-300'}`}>
                    {/* Display line */}
                </div>
            </div>
        )
