...
const ListClientsItem = ({cliente, eliminar, modificar, setopen, openModal}) => {
    ...
    return (
        ...
        <tr className="transition-all duration-500 ease-in-out hover:bg-gray-100  text-black font-medium border-b ">
            ...
            <td className="p-2 text-center bg-white  ">{cliente.correo}</td>
            ...
            <td className="p-2 text-center bg-white">
                ...
                <div className='flex justify-center items-center gap-4'>
                    <button onClick={() => modifyopen(modificar === cliente.id)} data-tooltip-id="my-tooltip-1" className="bg-[#FBE38F] text-[#7E7900] font-medium py-2 px-2 mt-1 rounded-full" ><RiEdit2Line /></button>

                    {/* () => eliminar(cliente.id) */}
                    <button onClick={() => openModal(cliente.id)} className="bg-[#FBDDD8] text-[#E85036] font-medium py-2 px-2 mt-1 rounded-full"><RiDeleteBin5Line /></button>
                    {/* <button onClick={() => modaldelete(eliminar === cliente.id)} data-tooltip-id="my-tooltip-2" className="bg-[#FBDDD8] text-[#E85036] font-medium py-2 px-2 mt-1 rounded-full"><RiDeleteBin5Line /></button> */}
